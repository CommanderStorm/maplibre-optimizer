...
mod tests {
    ...
    // ── Redundant properties folding ──────────────────────────────────────

    #[test]
    fn fold_get_with_redundant_properties() {
        let mir = sample_mir();
        let mut v = serde_json::json!({"version":8,"sources":{},"layers":[
            {"id":"x","type":"fill","filter":["==",["get","name",["properties"]],"v"]}
        ]});
        optimize_style_json_value(
            &mut v,
            &mir,
    ...
    fn fold_has_with_redundant_properties() {
        let mir = sample_mir();
        let mut v = serde_json::json!({"version":8,"sources":{},"layers":[
            {"id":"x","type":"fill","filter":["has","name",["properties"]]}
        ]});
        optimize_style_json_value(
            &mut v,
            &mir,
    ...
    fn has_folds_false_when_property_absent() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["has","missing"]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn has_folds_true_when_always_present() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["has","name"]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn geometry_type_eq_folds_true_when_only_type() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["==",["geometry-type"],"Point"]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn geometry_type_eq_folds_false_when_absent() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["==",["geometry-type"],"Polygon"]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn comparison_lt_folds_false_when_min_ge_n() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["<",["get","rank"],3]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn comparison_eq_folds_false_when_out_of_range() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["==",["get","rank"],99]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn in_prune_removes_dead_values() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["in",["get","class"],["literal",["lake","ocean","sea"]]]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn in_prune_all_dead_folds_to_false() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","filter":["in",["get","class"],["literal",["ocean","sea"]]]}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
            &mir,
    ...
    fn match_prune_removes_dead_arm() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"fill","source":"openmaptiles","source-layer":"water","paint":{
                "fill-color":["match",["get","class"],"lake","#00f","ocean","#009","#ccc"]
            }}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
    ...
    fn coalesce_truncates_after_always_present_arm() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"symbol","source":"openmaptiles","source-layer":"water","layout":{
                "text-field":["coalesce",["get","name"],["get","name_en"],"fallback"]
            }}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
    ...
    fn step_prune_above_max() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"line","source":"openmaptiles","source-layer":"water","paint":{
                "line-width":["step",["get","rank"],"small",3,"medium",7,"large"]
            }}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
    ...
    fn interpolate_prune_above_max() {
        ...
        let mut v = serde_json::json!({"version":8,"sources":{"openmaptiles":{"type":"vector","url":"x"}},"layers":[
            {"id":"w","type":"line","source":"openmaptiles","source-layer":"water","paint":{
                "line-width":["interpolate",["linear"],["get","rank"],1,0.5,3,1.5,5,2.5,8,4.0,10,5.0]
            }}
        ]});
        optimize_style_json_value_with_stats(
            &mut v,
