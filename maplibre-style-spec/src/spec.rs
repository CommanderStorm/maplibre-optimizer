...
mod test {
    ...
    #[rstest::rstest]
    #[case(serde_json::json!(["!",["has","point_count"]]))]
    #[case(serde_json::json!(["!=","cluster",true]))]
    #[case(serde_json::json!(["%",10,3]))]
    #[case(serde_json::json!(["*",2,3]))]
    #[case(serde_json::json!(["+",2,3]))]
    #[case(serde_json::json!(["-",10]))]
    #[case(serde_json::json!(["/",["get","population"],["get","sq-km"]]))]
    #[case(serde_json::json!(["<",["get","mag"],2]))]
    #[case(serde_json::json!(["<=",["get","mag"],6]))]
    #[case(serde_json::json!(["==","$type","Polygon"]))]
    #[case(serde_json::json!([">",["get","mag"],2]))]
    #[case(serde_json::json!([">=",["get","mag"],6]))]
    #[case(serde_json::json!(["^",2,3]))]
    #[case(serde_json::json!(["abs",-1.5]))]
    #[case(serde_json::json!(["accumulated"]))]
    #[case(serde_json::json!(["acos",1]))]
    #[case(serde_json::json!(["all",[">=",["get","mag"],4],["<",["get","mag"],5]]))]
    #[case(serde_json::json!(["any",[">=",["get","mag"],4],["<",["get","mag"],5]]))]
    #[case(serde_json::json!(["array","string",3,["literal",["a","b","c"]]]))]
    #[case(serde_json::json!(["asin",1]))]
    #[case(serde_json::json!(["at",1,["literal",["a","b","c"]]]))]
    #[case(serde_json::json!(["atan",1]))]
    #[case(serde_json::json!(["boolean",["feature-state","hover"],false]))]
    #[case(serde_json::json!(["case",["boolean",["feature-state","hover"],false],1,0.5]))]
    #[case(serde_json::json!(["ceil",1.5]))]
    #[case(serde_json::json!(["coalesce",["image",["concat",["get","icon"],"_15"]],["image","marker_15"]]))]
    #[case(serde_json::json!(["collator",{"case-sensitive":true,"diacritic-sensitive":true,"locale":"fr"}]))]
    #[case(serde_json::json!(["concat","square-rgb-",["get","color"]]))]
    #[case(serde_json::json!(["cos",1]))]
    #[case(serde_json::json!(["distance",{"coordinates":[0,0],"type":"Point"}]))]
    #[case(serde_json::json!(["downcase",["get","name"]]))]
    #[case(serde_json::json!(["e"]))]
    #[case(serde_json::json!(["elevation"]))]
    #[case(serde_json::json!(["feature-state","hover"]))]
    #[case(serde_json::json!(["floor",1.5]))]
    #[case(serde_json::json!(["format",["upcase",["get","FacilityName"]],{"font-scale":0.8},"\n\n",{},["downcase",["get","Comments"]],{"font-scale":0.6,"vertical-align":"center"}]))]
    #[case(serde_json::json!(["==",["geometry-type"],"Polygon"]))]
    #[case(serde_json::json!(["get","someProperty"]))]
    #[case(serde_json::json!(["global-state","someProperty"]))]
    #[case(serde_json::json!(["has","someProperty"]))]
    #[case(serde_json::json!(["heatmap-density"]))]
    #[case(serde_json::json!(["id"]))]
    #[case(serde_json::json!(["image","marker_15"]))]
    #[case(serde_json::json!(["in","$type","Point"]))]
    #[case(serde_json::json!(["index-of","foo",["baz","bar","hello","foo","world"]]))]
    #[case(serde_json::json!(["interpolate",["linear"],["zoom"],15,0,15.05,["get","height"]]))]
    #[case(serde_json::json!(["interpolate-hcl",["linear"],["zoom"],15,"#f00",15.05,"#00f"]))]
    #[case(serde_json::json!(["interpolate-lab",["linear"],["zoom"],15,"#f00",15.05,"#00f"]))]
    #[case(serde_json::json!(["is-supported-script","दिल्ली"]))]
    #[case(serde_json::json!(["length",["get","myArray"]]))]
    #[case(serde_json::json!(["let","someNumber",500,["interpolate",["linear"],["var","someNumber"],274,"#edf8e9",1551,"#006d2c"]]))]
    #[case(serde_json::json!(["line-progress"]))]
    #[case(serde_json::json!(["literal",["DIN Offc Pro Italic","Arial Unicode MS Regular"]]))]
    #[case(serde_json::json!(["ln",8]))]
    #[case(serde_json::json!(["ln2"]))]
    #[case(serde_json::json!(["log10",8]))]
    #[case(serde_json::json!(["log2",8]))]
    #[case(serde_json::json!(["match",["get","building_type"],"residential","#f00","commercial","#0f0","#000"]))]
    #[case(serde_json::json!(["max",1,2]))]
    #[case(serde_json::json!(["min",1,2]))]
    #[case(serde_json::json!(["number",["get","population"]]))]
    #[case(serde_json::json!(["number-format",["get","mag"],{"max-fraction-digits":1,"min-fraction-digits":1}]))]
    #[case(serde_json::json!(["object",["get","some-property"]]))]
    #[case(serde_json::json!(["pi"]))]
    #[case(serde_json::json!(["properties"]))]
    #[case(serde_json::json!(["resolved-locale",["collator",{"case-sensitive":true,"diacritic-sensitive":false,"locale":"de"}]]))]
    #[case(serde_json::json!(["rgb",255,0,0]))]
    #[case(serde_json::json!(["rgba",255,0,0,1]))]
    #[case(serde_json::json!(["round",1.5]))]
    #[case(serde_json::json!(["sin",1]))]
    #[case(serde_json::json!(["slice",["get","name"],0,3]))]
    #[case(serde_json::json!(["sqrt",9]))]
    #[case(serde_json::json!(["step",["get","point_count"],20,100,30,750,40]))]
    #[case(serde_json::json!(["string",["get","name"]]))]
    #[case(serde_json::json!(["tan",1]))]
    #[case(serde_json::json!(["to-boolean","someProperty"]))]
    #[case(serde_json::json!(["to-color","#edf8e9"]))]
    #[case(serde_json::json!(["to-number","someProperty"]))]
    #[case(serde_json::json!(["to-rgba","#ff0000"]))]
    #[case(serde_json::json!(["to-string",["get","mag"]]))]
    #[case(serde_json::json!(["typeof",["get","name"]]))]
    #[case(serde_json::json!(["upcase",["get","name"]]))]
    #[case(serde_json::json!(["var","density"]))]
    #[case(serde_json::json!(["within",{"coordinates":[[[0,0],[0,5],[5,5],[5,0],[0,0]]],"type":"Polygon"}]))]
    #[case(serde_json::json!(["interpolate",["linear"],["zoom"],15,0,15.05,["get","height"]]))]
...
pub enum ExpressionName {
    ...
    NotEqual(Input1, Input2, Option<Collator>),
    /// Returns the remainder after integer division of the first input by the second.
    Percentage(Input1, Input2),
    /// Returns the product of the inputs.
    Star(Vec<WeirdVariadic>),
    /// Returns the sum of the inputs.
    Plus(Vec<WeirdVariadic>),
    ...
    EqualEqual(Input1, Input2, Option<Collator>),
    ...
    Boolean(Vec<WeirdVariadic>),
    /// Selects the first output whose corresponding test condition evaluates to true, or the fallback value otherwise.
    ///
    ///  - [Create a hover effect](https://maplibre.org/maplibre-gl-js/docs/examples/create-a-hover-effect/)
    ///
    ///  - [Display HTML clusters with custom properties](https://maplibre.org/maplibre-gl-js/docs/examples/display-html-clusters-with-custom-properties/)
    Case(Vec<WeirdVariadic>),
    ...
    Get(PropertyName, Option<Object>),
    ...
    ///
    ///  - [Create and style clusters](https://maplibre.org/maplibre-gl-js/docs/examples/create-and-style-clusters/)
    Has(PropertyName, Option<Object>),
    ...
    InterpolateHcl(Vec<WeirdVariadic>),
    ...
    InterpolateLab(Vec<WeirdVariadic>),
    ...
    Match(Vec<WeirdVariadic>),
    /// Returns the maximum value of the inputs.
    Max(Vec<WeirdVariadic>),
    /// Returns the minimum value of the inputs.
    Min(Vec<WeirdVariadic>),
    /// Asserts that the input value is a number. If multiple values are provided, each one is evaluated in order until a number is obtained. If none of the inputs are numbers, the expression is an error.
    Number(Vec<WeirdVariadic>),
    ...
    ///
    ///  - [Display HTML clusters with custom properties](https://maplibre.org/maplibre-gl-js/docs/examples/display-html-clusters-with-custom-properties/)
    NumberFormat(Input, FormatOptions),
    /// Asserts that the input value is an object. If multiple values are provided, each one is evaluated in order until an object is obtained. If none of the inputs are objects, the expression is an error.
    Object(Vec<WeirdVariadic>),
    ...
    ///
    ///  - [Create and style clusters](https://maplibre.org/maplibre-gl-js/docs/examples/create-and-style-clusters/)
    Step(Vec<WeirdVariadic>),
    /// Asserts that the input value is a string. If multiple values are provided, each one is evaluated in order until a string is obtained. If none of the inputs are strings, the expression is an error.
    String(Vec<WeirdVariadic>),
