...
# Install render test Node.js dependencies
...
[private]
clean-gen:
    rm -f maplibre-style-spec/src/spec.rs
    rm -rf maplibre-style-spec/src/spec
    mkdir -p maplibre-style-spec/src/spec
    # Placeholder to keep the directory present for rustfmt; real contents are generated by `gen`.
    echo "pub mod literals; pub mod root; pub mod named_types; pub mod expressions; pub mod sources; pub mod layers;" > maplibre-style-spec/src/spec/mod.rs

# Install benchmark Node.js dependencies
